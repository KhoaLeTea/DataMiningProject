...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth, center]{b_rating_by_state}
...
\begin{figure}[!h]
\includegraphics[width=0.5\textwidth, center]{3d_businesses_lat_long}
